...
@Component({
  ...
  template: `
    <gf-page-header title="Mentor encouragement" eyebrow="Unavailable">
      <p>
        This operation is not available because the backend does not publish an authorized mentor encouragement
        capability.
      </p>
    </gf-page-header>
...
export class MentorEncouragementUnavailableComponent {}
