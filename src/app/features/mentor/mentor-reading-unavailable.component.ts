...
@Component({
  ...
  template: `
    <gf-page-header title="Mentor reading" eyebrow="Unavailable">
      <p>
        This operation is not available because the backend does not publish an authorized mentor reading-review
        capability.
      </p>
    </gf-page-header>
...
export class MentorReadingUnavailableComponent {}
