...
@Component({
  ...
  template: `
    <gf-page-header title="Teams administration" eyebrow="Unavailable">
      <p>
        This operation is not available because the backend does not publish an authorized teams administration
        capability.
      </p>
    </gf-page-header>
...
export class AdminTeamsUnavailableComponent {}
