...
@Component({
  ...
  template: `
    <gf-page-header title="Character administration" eyebrow="Unavailable">
      <p>
        This operation is not available because the backend does not publish an authorized character administration
        capability.
      </p>
    </gf-page-header>
...
export class AdminCharacterUnavailableComponent {}
