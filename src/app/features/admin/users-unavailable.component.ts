...
@Component({
  ...
  template: `
    <gf-page-header title="Users administration" eyebrow="Unavailable">
      <p>
        This operation is not available because the backend does not publish an authorized users administration
        capability.
      </p>
    </gf-page-header>
...
export class AdminUsersUnavailableComponent {}
