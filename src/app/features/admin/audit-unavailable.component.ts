...
@Component({
  ...
  template: `
    <gf-page-header title="Audit administration" eyebrow="Unavailable">
      <p>
        This operation is not available because the backend does not publish an authorized audit administration
        capability.
      </p>
    </gf-page-header>
...
export class AdminAuditUnavailableComponent {}
