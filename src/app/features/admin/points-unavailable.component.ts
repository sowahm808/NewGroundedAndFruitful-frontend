...
@Component({
  ...
  template: `
    <gf-page-header title="Points administration" eyebrow="Unavailable">
      <p>
        This operation is not available because the backend does not publish an authorized points administration
        capability.
      </p>
    </gf-page-header>
...
export class AdminPointsUnavailableComponent {}
