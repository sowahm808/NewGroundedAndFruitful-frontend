...
@Component({
  ...
  template: `
    <gf-page-header title="Books administration" eyebrow="Unavailable">
      <p>
        This operation is not available because the backend does not publish an authorized books administration
        capability.
      </p>
    </gf-page-header>
...
export class AdminBooksUnavailableComponent {}
