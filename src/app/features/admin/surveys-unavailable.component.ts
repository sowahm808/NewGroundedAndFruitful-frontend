...
@Component({
  ...
  template: `
    <gf-page-header title="Surveys administration" eyebrow="Unavailable">
      <p>
        This operation is not available because the backend does not publish an authorized surveys administration
        capability.
      </p>
    </gf-page-header>
...
export class AdminSurveysUnavailableComponent {}
