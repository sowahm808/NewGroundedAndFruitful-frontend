...
@Component({
  ...
  template: `
    <gf-page-header title="Bible administration" eyebrow="Unavailable">
      <p>
        This operation is not available because the backend does not publish an authorized bible administration
        capability.
      </p>
    </gf-page-header>
