...
@Component({
  ...
  template: `
    <gf-page-header title="Family administration" eyebrow="Unavailable">
      <p>
        This operation is not available because the backend does not publish an authorized family administration
        capability.
      </p>
    </gf-page-header>
...
export class AdminFamilyUnavailableComponent {}
