...
@Component({
  ...
  template: `
    <gf-page-header title="Observer observations" eyebrow="Unavailable">
      <p>
        This operation is not available because the backend does not publish an authorized observer observation
        capability.
      </p>
    </gf-page-header>
...
export class ObserverObservationsUnavailableComponent {}
